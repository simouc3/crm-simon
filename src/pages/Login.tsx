        ...
        <div className="relative z-10 flex flex-col justify-between p-20 w-full">
           ...
           <div className="max-w-md space-y-6">
              ...
              <div className="flex items-center gap-6 pt-4">
                 ...
                 <span className="text-xs font-bold text-white/40 uppercase tracking-widest">Utilizado por el equipo comercial de Elite</span>
              </div>
           </div>
        ...
        <div className="w-full max-w-[420px] space-y-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              <h2 className="text-2xl font-black tracking-tight text-foreground">{isSignUp ? 'Crea tu Cuenta' : 'Inicia Sesión'}</h2>
              <p className="text-sm font-medium text-muted-foreground">{isSignUp ? 'Únete para empezar a cerrar tratos.' : 'Bienvenido de nuevo al panel central.'}</p>
            </div>

            <div className="grid gap-4 pt-2">
               <button 
                onClick={handleGoogleLogin}
                className="w-full h-14 rounded-2xl border-2 border-border/40 bg-white dark:bg-slate-900 flex items-center justify-center gap-3 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all duration-300 active:scale-[0.98] shadow-sm relative group overflow-hidden"
               >
                 ...
                 <svg className="w-5 h-5 relative z-10" viewBox="0 0 24 24">
                   ...
                   <path fill="#4285F4" d="M23.49 12.27c0-.79-.07-1.54-.19-2.27h-11.3v4.51h6.47c-.29 1.48-1.14 2.73-2.4 3.58l3.89 3c2.28-2.1 3.53-5.2 3.53-8.82z" />
                 ...
                 <span className="text-sm font-black uppercase tracking-widest text-foreground relative z-10">Continuar con Google</span>
               </button>

               <div className="relative py-4">
                 <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-border/40"></div></div>
                 <div className="relative flex justify-center text-[10px] font-black uppercase tracking-widest"><span className="bg-white dark:bg-slate-950 px-4 text-muted-foreground opacity-40">O mediante correo</span></div>
               </div>

               <form onSubmit={handleAuth} className="space-y-4">
                {isSignUp && (
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-semibold text-muted-foreground uppercase tracking-widest ml-1">Nombre Comercial</label>
                    <div className="relative">
                       ...
                       <input 
                        ...
                        placeholder="Ej: Simon Administrador"
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] font-semibold text-muted-foreground uppercase tracking-widest ml-1">Correo Electrónico</label>
                  <div className="relative">
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] font-semibold text-muted-foreground uppercase tracking-widest ml-1">Contraseña</label>
                  <div className="relative">
                ...
                <Button type="submit" className="w-full h-14 rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl shadow-primary/20 mt-2 flex items-center justify-center gap-2 group transition-all" disabled={loading}>
                  {loading ? 'Validando...' : (isSignUp ? 'Crear Registro' : 'Entrar al Control')}
               ...
               <div className="text-center pt-2">
                <button 
                  ...
                  className="text-[11px] font-black text-muted-foreground uppercase tracking-widest hover:text-primary transition-colors underline-offset-4 hover:underline"
                >
                  {isSignUp ? '¿Ya tienes acceso? Inicia Sesión' : '¿Nuevo Operador? Solicita Acceso'}
                </button>
              </div>
            </div>
          </div>
